...
var FrontStreet = {
	doComponent: function( component ) {
		...
		if ( 'undefined' === typeof FrontStreetConfig ) {
			return true;
		}

		if ( 'undefined' !== typeof FrontStreetConfig[ component ] && ( false === FrontStreetConfig[ component ] || 'false' === FrontStreetConfig[ component ] ) ) {
			return false;
		}
